...
//	vector<vector<double>> A1 = {{2,0,2,0.6},{3,3,4,-2},{5,5,4,2},{-1,-2,3.4,-1}};
//	vector<vector<double>> A = {{2,3,1,5},{6,13,5,19},{2,19,10,23},{4,10,11,31}};
//	vector<int> pi1 = LUPDecomposition(A1);
//
//	for(int i:pi1) cout << i << " ";
//	cout << endl;
//	for(auto r:A1) {
...
//	}
//
//	vector<vector<double>> A2 = {{1,2,0},{3,4,4},{5,6,3}};
//	vector<double> b2 = {3,7,8};
//	vector<int> pi2 = LUPDecomposition(A2);
//	for(int i:pi2) cout << i << " ";
//	cout << endl;
//	for(auto r:A2) {
//		for(double x:r) cout << x << " ";
//		cout << endl;
//	}
//	vector<double> x = LUPSolve(A2,pi2,b2);
